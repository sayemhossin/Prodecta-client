...
import { FaArrowDown, FaArrowUp, FaCalendar, FaStar } from 'react-icons/fa';
...
const Products = () => {
    ...
    return (
        <div>
            ...
            <div className='md:flex mb-10 md:mb-20 flex-row-reverse text-center lg:mx-60 items-center justify-around'>
           <div>
           <details className="dropdown md:mb-0 mb-5" onClick={() => setArr(!arr)}>
                <summary className="m-1 border-2 rounded-lg p-4 cursor-pointer  text-gray-600   ">Sort By Date & Time
                </summary>
